...
# if sys.version_info >= (3, 11, 0, 'final', 1):
#     print('뜻은 뭐지?')
#     print('이제 알겠다 sys.version_info에 보면은')
#     print('(3,11,0,final,0) 나오는데 이것보다 크거나 같다라는식으로하니까')
#     print('이것을 통해서 판별해서 print나오는지 안나오는지 확인한다는것이다')
